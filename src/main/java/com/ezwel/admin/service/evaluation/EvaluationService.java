...
public class EvaluationService {
	...
	public Paging<Evaluation> getPtnSurveyAnsList(EvaluationDto evalDto) {
		Paging<Evaluation> paging = new Paging<Evaluation>();
		paging.setPaging(evalDto);
		List<Evaluation> evalList = evaluationMapper.getPtnSurveyAnsList(evalDto) ; 
		
		paging.setList(evalList);
		evalDto.setPageCommonFlag(true);
		paging.setTotalCount(evaluationMapper.getPtnSurveyAnsList(evalDto).get(0).getPageCommonCount());
		return paging;
	}
	...
	public void updateHappyCallShow(EvaluationDto evalDto){
		...
		evaluationMapper.updateHappyCallShow(evalDto);
