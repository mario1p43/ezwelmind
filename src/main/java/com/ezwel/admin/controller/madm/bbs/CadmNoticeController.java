...
@Controller
@RequestMapping("/madm/cadmNotice")
public class CadmNoticeController {
	private static Logger log = LoggerFactory.getLogger(CadmNoticeController.class);
	...
	public String cadmNotice(@ModelAttribute BBSAddDto bbsDto, Model model) {
		setMenu(model);
		...
		return "madm/bbs/cadm/cadmNotice";
	}

	@RequestMapping(value = "/addForm")
	public String cadmAddNotice(@ModelAttribute BBSAddDto bbsDto, Model model) {
		setMenu(model);
		model.addAttribute("serviceType", bbsDto.getServiceType());
		model.addAttribute("bbsCd", bbsDto.getBbsCd());
		model.addAttribute("viewMode", "add");
		model.addAttribute("clientList", commonService.getClientList());
		return "madm/bbs/cadm/cadmAddNotice";
	}
	...
	public String insertNotice(@ModelAttribute BBSAddDto bbsAddDto, Model model, HttpServletRequest request,
		...
		return "redirect:/madm/cadmAddNotice/list?serviceType="+serviceType+"&bbsCd="+bbsCd;
	}
	...
	public String updateNotice(@ModelAttribute BBSAddDto bbsAddDto, Model model, HttpServletRequest request,
		...
		return "redirect:/madm/cadmAddNotice/modifyNoticeDetailForm?dataSeq=" + bbsAddDto.getDataSeq();
	} 
	...
	public String deleteNotice(@ModelAttribute BBSAddDto bbsAddDto, Model model) {
		...
		return "redirect:/madm/cadmAddNotice/list";
	}
}