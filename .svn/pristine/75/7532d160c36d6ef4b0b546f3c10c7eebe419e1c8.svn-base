...
j$(document).ready(function(){
	...
	j$(".publicDetail").click(function(){
		...
		location.href = "/madm/bbsPublic/modifyPublicDetailForm2?dataSeq="+dataSeq+"&bbsCd="+bbsCd+"&serviceType="+serviceType;
		return false;
	});
...
<form:form id="searchPublic" modelAttribute="bbsAddDto" action="/madm/bbsPublic/list2" method="GET">
