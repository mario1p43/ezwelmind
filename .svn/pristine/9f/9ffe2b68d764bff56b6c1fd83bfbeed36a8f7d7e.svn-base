...
j$(document).ready(function(){
	...
	j$("#insertBtn").click(function(){
		...
		location.href = "/madm/bbsGallery/addForm?serviceType="+serviceType+"&bbsCd="+bbsCd;
		return false;
	});

	j$(".galleryDetail").click(function(){
		var dataSeq = j$(this).attr("value");
		var bbsCd = j$("#bbsCd").val();
		var serviceType = j$("#serviceType").val();
		location.href = "/madm/bbsGallery/modifyGalleryDetailForm?dataSeq="+dataSeq+"&bbsCd="+bbsCd+"&serviceType="+serviceType;
		return false;
	});
...
<form:form id="searchGallery" modelAttribute="bbsAddDto" action="/madm/bbsGallery/list" method="GET">
...
<tr>
	<td>
		...
		<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center" style="border-bottom: 1px solid silver;">
			<tr>
		    	<td align="left" class="subtitle">갤러리 등록 관리</td>
			</tr>
		</table>
		<!-- 버튼 영역 종료 -->
	</td>
		...
		<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;" bordercolor="#DDDDDD">
			<tr align="left" height="30px">
		    	...
		    	<td width="40%" colspan="3" align="left">
		    		<input type="text" id="searchNm" name="searchNm" placeholder="제목을 입력 하세요." value="${param.searchNm}" style="width:350px; height:20px;"/>
		    	</td>
			</tr>
			<tr>
		    	...
		    	<td width="40%" align="left">
		    		...
		    		<input type="text" id="regNm" name="regNm" placeholder="검색어를 입력하세요." value="${param.regNm }" style="width:350px; height:20px;">
		    	</td>
	    	</tr>
			<tr align="left" height="30px">
			...
			<tr>
				<td align="center" colspan="4">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td id="btn01"><a href="javascript:void(0);"><span id="insertBtn">신규등록</span></a></td>
							<td width="30px"></td>
					...
					<table class="" cellpadding="5" align="" id="chRow" cellspacing="0" border="1" width="100%" style="text-align:center; border-collapse:collapse;">
						...
						<c:forEach var="list" items="${paging.list}" varStatus="status">
							<tr align="" height="50px">
								...
								<td><a href="#" class="galleryDetail" value="${list.dataSeq}"><strong>${list.subject}</strong></a></td>
								<c:choose>
