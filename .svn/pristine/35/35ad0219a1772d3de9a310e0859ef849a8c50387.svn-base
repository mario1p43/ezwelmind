...
<form:form id="searchService" modelAttribute="bbsAddDto" action="/madm/bbsInquiry/serviceList" method="GET">
...
<tr>
	<td>
		...
		<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center" style="border-bottom: 1px solid silver;">
			<tr>
		    	<td align="left" class="subtitle">서비스문의</td>
			</tr>
		</table>
		<!-- 버튼 영역 종료 -->
					...
					<table class="" cellpadding="5" align="" id="chRow" cellspacing="0" border="1" width="100%" style="text-align:center; border-collapse:collapse;">
						...
						<c:forEach var="list" items="${paging.list}" varStatus="status">
							<tr>
								...
								<td><a href="/madm/bbsInquiry/serviceDetail?dataSeq=${list.dataSeq}"><strong>${list.regCompany}</strong></a></td>
								<td>${list.regNm}</td>
								<td>${list.regEmail}</td>
