...
j$(document).ready(function(){
	...
	j$("#insertBtn").click(function(){
		...
		location.href = "/madm/bbsColumn/addForm?serviceType="+serviceType;
		return false;
	});

	j$(".noticeDetail").click(function(){
		var dataSeq = j$(this).attr("value");
		location.href = "/madm/bbsColumn/modifyColumnDetailForm?dataSeq="+dataSeq;
		return false;
	});
...
<form:form id="searchNotice" modelAttribute="bbsAddDto" action="/madm/bbsColumn/list" method="GET">
...
<tr>
	<td>
		...
		<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center" style="border-bottom: 1px solid silver;">
			<tr>
		    	<td align="left" class="subtitle">칼럼/웹진 등록 관리</td>
		    	<td align="right">
...
<%-- 								<td class="" width="" align="" bgcolor="">${list.reqCd1}</td> --%>
