...
j$(document).ready(function(){
	...
	j$("input").keypress(function(e) {
	    if (e.which == 13){
	    	j$("#searchPress").submit();
			return false;
	    };
	});

	j$("#insertBtn").click(function(){
		location.href = "/madm/bbsPress/addForm";
		return false;
	});
	...
	j$(".pressDetail").click(function(){
		var dataSeq = j$(this).attr("value");
		location.href = "/madm/bbsPress/modifyPressDetailForm?dataSeq="+dataSeq;
		return false;
	});
...
<form:form id="searchPress" modelAttribute="bbsAddDto" action="/madm/bbsPress/list" method="GET">
...
<tr>
	<td>
		...
		<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center" style="border-bottom: 1px solid silver;">
			<tr>
		    	<td align="left" class="subtitle">언론보도 등록 관리</td>
		    	<td align="right">
					...
					<table class="" cellpadding="5" align="" id="chRow" cellspacing="0" border="1" width="100%" style="text-align:center; border-collapse:collapse;">
						...
						<c:forEach var="list" items="${paging.list}" varStatus="status">
							<tr align="" height="50px">
								...
								<td>
									<a href="#" class="pressDetail" value="${list.dataSeq}">
