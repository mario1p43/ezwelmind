...
@Controller
@RequestMapping("/madm/partnerNotice")
public class PartnerNoticeController {
	private static Logger log = LoggerFactory.getLogger(PartnerNoticeController.class);
	...
	public String bbsNotice(@ModelAttribute BBSAddDto bbsDto, Model model) {
		...
		return "madm/bbs/partner/partnerNotice";
	}
	...
	public String addNotice(@ModelAttribute BBSAddDto bbsDto, Model model) {
		...
		return "madm/bbs/partner/partnerAddNotice";
	}
	...
	public String insertNotice(@ModelAttribute BBSAddDto bbsAddDto, Model model, HttpServletRequest request,
		...
		return "redirect:/madm/partnerNotice/list?serviceType="+serviceType+"&bbsCd="+bbsCd;
	}
	...
	public String updateNotice(@ModelAttribute BBSAddDto bbsAddDto, Model model, HttpServletRequest request,
		...
		return "redirect:/madm/partnerNotice/modifyNoticeDetailForm?dataSeq=" + bbsAddDto.getDataSeq();
	} 
	...
	public String deleteNotice(@ModelAttribute BBSAddDto bbsAddDto, Model model) {
		...
		return "redirect:/madm/partnerNotice/list";
	}
}