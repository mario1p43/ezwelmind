...
//		MIND_COMM_CD, 고객산 예산상태 - 적용
	 ...
	 * @param model
	 */
	@RequestMapping("/getAllClientJedo")
	public void getAllClientJedo(OperationsDto operationsDto, Model model) {
		Map<String, List<ClientJedoPeriod>> map = operationsService.getAllClientJedo(operationsDto);
