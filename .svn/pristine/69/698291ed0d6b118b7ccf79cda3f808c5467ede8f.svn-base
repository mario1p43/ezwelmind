...
j$(document).ready(function(){
	...
	j$("#insertBtn").click(function(){
		...
		location.href = "/madm/bbsNotice/addForm?serviceType="+serviceType+"&bbsCd="+bbsCd;
		return false;
	});
	...
	j$(".noticeDetail").click(function(){
		...
		var bbsCd = j$("#bbsCd").val();
		var serviceType = j$("#serviceType").val();
		location.href = "/madm/bbsNotice/modifyNoticeDetailForm?dataSeq="+dataSeq+"&bbsCd="+bbsCd+"&serviceType="+serviceType;
		return false;
	});
...
<form:form id="searchNotice" modelAttribute="bbsAddDto" action="/madm/bbsNotice/list" method="GET">
		...
		<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;" bordercolor="#DDDDDD">
			<tr align="left" height="30px">
				...
				<td width="40%" colspan="3" align="left">
					<comm:select name="reqCd1" code="101042"  basicValue="------선택------" selectValue="${param.reqCd1}"/>
				</td>
			</tr>
			<tr align="left" height="30px">
