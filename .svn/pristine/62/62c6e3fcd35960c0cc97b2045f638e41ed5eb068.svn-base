...
j$(document).ready(function(){
	...
	j$("#insertBtn").click(function(){
		...
		location.href = "/madm/cadmNotice/addForm?serviceType="+serviceType+"&bbsCd="+bbsCd;
		return false;
	});
	...
	j$(".noticeDetail").click(function(){
		...
		var bbsCd = j$("#bbsCd").val();
		var serviceType = j$("#serviceType").val();
		location.href = "/madm/cadmNotice/modifyNoticeDetailForm?dataSeq="+dataSeq+"&bbsCd="+bbsCd+"&serviceType="+serviceType;
		return false;
	});
...
<form:form id="searchNotice" modelAttribute="bbsAddDto" action="/madm/cadmNotice/list" method="GET">
