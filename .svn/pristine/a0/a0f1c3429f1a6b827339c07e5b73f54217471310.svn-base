...
j$(document).ready(function(){
	...
	j$(".inquiryDetail").click(function(){
		var dataSeq = j$(this).attr("value");
		var bbsCd = j$("#bbsCd").val();
		var serviceType = j$("#serviceType").val();
		location.href = "/madm/bbsInquiry/modifyInquiryDetailForm?dataSeq="+dataSeq+"&bbsCd="+bbsCd+"&serviceType="+serviceType;
		return false;
	});
...
<form:form id="searchInquiry" modelAttribute="bbsAddDto" action="/madm/bbsInquiry/list" method="GET">
...
<tr>
	<td>
		...
		<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center" style="border-bottom: 1px solid silver;">
			<tr>
		    	<td align="left" class="subtitle">1:1문의내역 관리</td>
			</tr>
		</table>
		<!-- 버튼 영역 종료 -->
	</td>
					...
					<table class="" cellpadding="5" align="" id="chRow" cellspacing="0" border="1" width="100%" style="text-align:center; border-collapse:collapse;">
						...
						<c:forEach var="list" items="${paging.list}" varStatus="status">
							<tr align="" height="50px">
								...
								<td align="center"><a href="javascript:void(0)" class="inquiryDetail" value="${list.dataSeq}" style="padding-left: 10px;"><strong>${list.subject}</strong></a></td>
								<c:choose>
								...
								<td align="center">
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<c:choose>
												<c:when test="${list.statusNm ne '답변완료'}">
													<td id="btn02">
