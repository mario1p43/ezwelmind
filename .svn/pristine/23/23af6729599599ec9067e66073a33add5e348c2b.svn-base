...
j$(document).ready(function(){
	...
	j$("#insertBtn").click(function(){
		...
		location.href = "/madm/sangdam4uNotice/addForm?serviceType="+serviceType+"&bbsCd="+bbsCd;
		return false;
	});
	...
	j$(".noticeDetail").click(function(){
		...
		var bbsCd = j$("#bbsCd").val();
		var serviceType = j$("#serviceType").val();
		location.href = "/madm/sangdam4uNotice/modifyNoticeDetailForm?dataSeq="+dataSeq+"&bbsCd="+bbsCd+"&serviceType="+serviceType;
		return false;
	});
...
<form:form id="searchNotice" modelAttribute="bbsAddDto" action="/madm/sangdam4uNotice/list" method="GET">
...
<tr>
	<td>
		...
		<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center" style="border-bottom: 1px solid silver;">
			<tr>
		    	<td align="left" class="subtitle">공지사항 등록 관리</td>
			</tr>
		</table>
		<!-- 버튼 영역 종료 -->
	</td>
		...
		<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;" bordercolor="#DDDDDD">
			<tr align="left" height="30px">
		    	...
		    	<td width="40%" align="left">
		    		...
		    		<input type="text" id="regNm" name="regNm" placeholder="이름을 입력하세요." value="${param.regNm }" style="width:350px; height:20px;">
		    	</td>
			</tr>
			<tr align="left" height="30px">
				<td width="10%" bgcolor="#F5F5F5" align="center"><strong>구분</strong></td>
		    	<td width="40%" align="left" >
		    		<comm:select name="reqCd1" code="100549" selectValue="${param.reqCd1 }" basicValue="---- 선택 ----" />
		    	</td>
