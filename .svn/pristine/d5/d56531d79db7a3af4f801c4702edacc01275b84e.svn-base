...
<form id="cspModify" name="cspModify" action="/madm/service/csp/cspInfoUpdate" method="POST" enctype="multipart/form-data">
<input type="hidden" name="cType" id="cType" >
<input type="hidden" name="cspCd" value="${cspInfo.cspCd }">
			...
			<tr>
				<td>
					<table cellpadding="5" cellspacing="0" border="0" width="100%" align="left" style="border-bottom: 1px solid silver;">
						<tr>
					    	<td align="left" class="subtitle">제휴사 수정</td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<ul>
					...
					<table cellpadding="4" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;">
						...
						<tr align="left" height="30px">
					    	...
					    	<td class="line" width="35%">
					    		<input type="text" name="seedKey" id="seedKey" value="${cspInfo.seedKey}" style="width: 500px;"/>
					    	</td>
						</tr>
						<tr align="left" height="30px">
							<th class="line" width="15%" align="left" bgcolor="#F5F5F5">&nbsp;&nbsp;ASP 접속주소</th>
					    	<td class="line" width="35%">
					    		<input type="text" name="firstUrl" id="firstUrl" value="${cspInfo.firstUrl}" style="width: 500px;"/>
					    	</td>
					    	<th class="line" width="15%" align="left" bgcolor="#F5F5F5">&nbsp;&nbsp;ASP 주문주소</th>
					    	<td class="line" width="35%">
					    		<input type="text" name="orderUrl" id="orderUrl" value="${cspInfo.orderUrl}"  style="width: 500px;"/>
					    	</td>
						</tr>
						<tr align="left" height="30px">
							<th class="line" width="15%" align="left" bgcolor="#F5F5F5">&nbsp;&nbsp;ASP 취소주소</th>
					    	<td class="line" width="35%">
					    		<input type="text" name="cancelUrl" id="cancelUrl" value="${cspInfo.cancelUrl}" style="width: 500px;"/>
					    	</td>
					    	<th class="line" width="15%" align="left" bgcolor="#F5F5F5">&nbsp;&nbsp;ASP 주문정보 위변조 확인주소</th>
					    	<td class="line" width="35%">
					    		<input type="text" name="checkUrl" id="checkUrl" value="${cspInfo.checkUrl}"  style="width: 500px;"/>
					    	</td>
						</tr>	
					</table>
					<ul>
