...
///////////////////////////////////////////////
	...
	j$("#cancelBtn").click(function(){
		location.href = "/partner/service/management/adddelaygoods";
	});
	...
	j$("#viewBtn").click(function(){
		...
		//j$("#goodsform").attr("action","/partner/service/enrollment/onlinegoodsview");
		//j$("#goodsform").submit();
	});
...
<body>
<form id="goodsform" name="goodsform" action="/partner/service/enrollment/updateGoods" method="POST" enctype="multipart/form-data">
