...
j$(document).ready(function(){
	...
	j$("#insertBtn").click(function(){
		...
		location.href = "/partner/hueNotice/addForm?serviceType="+serviceType+"&bbsCd="+bbsCd;
		return false;
	});
	...
	j$(".noticeDetail").click(function(){
		...
		var bbsCd = j$("#bbsCd").val();
		var serviceType = j$("#serviceType").val();
		location.href = "/partner/hueNotice/modifyNoticeDetailForm?dataSeq="+dataSeq+"&bbsCd="+bbsCd+"&serviceType="+serviceType;
		return false;
	});
...
<form:form id="searchNotice" modelAttribute="bbsAddDto" action="/partner/hueNotice/list" method="GET">
...
<tr>
	<td>
		...
		<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center" style="border-bottom: 1px solid silver;">
			<tr>
		    	<td align="left" class="subtitle">휴소식 등록 관리</td>
			</tr>
		</table>
		<!-- 버튼 영역 종료 -->
	</td>
