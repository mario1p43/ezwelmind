...
<style>
	...
	.has-validation-callback{padding:0 5vw}
	...
	.has-validation-callback .data-list-wrapper select{width:22vw;height:8vw;padding:0 2vw;border:1px solid #828282;background:url('/resources/img/ic_select.png') no-repeat;background-size:12px 7px;background-position:right 6px top 50%;background-color:white;-webkit-appearance:none;-moz-appearance:no
</style>
	...
	<td valign="top" align="left">
		<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;">
			<tr align="left" height="30px">ㆍ개인정보
				...
				<td width="40%"><input type="text" name="userNm" data-validation="required" data-validation-error-msg-required="성명을 확인해주세요.">ㆍ한글로 입력하세요 </td>
			...
			<tr align="left" height="30px">
				...
				<td><input type="password" name="userPwd" id="userPwd" data-validation="alphanumeric" data-validation-error-msg="비밀번호를 확인해주세요.">ㆍ영문자(소문자,대문자)+숫자의 조합으로 6~12자로 입력하세요.</td>
				<th class="line" height="30" align="left" bgcolor="#F5F5F5" width="10%">* 비밀번호 확인</th>
				<td><input type="password" name="userPwdChk" id="userPwdChk" data-validation="alphanumeric" data-validation-error-msg="비밀번호 학인을 확인해주세요."></td>
			</tr>
			<tr align="left" height="30px">
...
<br/>ㆍ상담유형
		<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;">
			<tr>
				<td colspan="2" class="line" height="30" align="left" bgcolor="#F5F5F5" width="15%">* 유형선택</td>
				<td>
