...
/* 			if('${mgr.mgrStatus}' == 'Y'){
		...
		j$('#updateBtn').click(function() {
			...
			var infoMsg ="";
			var mobilesms2 = $("#mobilesms2").val();
			var mobilesms3 = $("#mobilesms3").val();
			var oldSmsMobile2= $("#oldSmsMobile2").val();
			var oldSmsMobile3= $("#oldSmsMobile3").val();
			if(mobilesms2 != oldSmsMobile2 || mobilesms3 != oldSmsMobile3){
				infoMsg ="SMS 인증용 연락처를 변경하시겠습니까?";
	...
	function updateMobile(){
		$("#updateCounselorInfoMgr").attr("action","/partner/mgr/updateUserMobile");
		j$("#updateCounselorInfoMgr").submit();
	}
...
<input type="hidden" id="oldSmsMobile2" value="${mgr.mobilesms2 }"/>
<input type="hidden" id="oldSmsMobile3" value="${mgr.mobilesms3 }"/>
