...
$(document).ready(function(){
	...
	$(".time").click(function(){
		if($(this).prev().prev().children().is(":checked")){
			
	 		$(this).prev().prev().children().prop("checked", false);
	 		$(this).prev().children().prop("checked", false);
	 		$(this).css("background","white");
			
		}else if($(this).prev().children().is(":checked")){
			...
			$(this).prev().prev().children().prop("checked", true);
			$(this).prev().children().prop("checked", false);
			$(this).css("background","#074f89");
		}
	});
