...
<style>
	...
	.counsel-wrapper .content-wrapper .data-wrapper .risk-dropdown{padding:2.2vw;text-align:center;background:url('/resources/img/arrow_bottom.png') no-repeat;background-position:right 15px top 50%}
	...
	.counsel-wrapper .content-wrapper .data-wrapper .data-block .counsel-subject-select select{float:left;width:calc(33% - 0.37vw)!important;height:9vw;padding:0 2.5vw;margin-right:1vw;font-size:14px;background:url('/resources/img/ic_select.png') no-repeat;background-size:12px 7px;background-position:right 6px top 50%;-webkit-appearance:none;-moz-appearance:none;appearance:none;}
...
<form id="counselDtlInsert" name="counselDtlInsert" action="/partner/pCounselorMgr/pCounselorDtlInsert" method="POST" enctype="multipart/form-data">
	...
	<div class="counsel-wrapper">
		...
		<div class="content-wrapper">
			<div class="data-wrapper border-bottom">
				<div class="label-block-line">다음 중 본 사례에 해당하는 위험도를 체크해 주십시오.</div>
			</div>
			<div class="data-wrapper border-bottom">
