...
<style>
	...
	<tr>
		          <td ><span class="moveLeft" style="cursor: pointer;padding: 2px 5px;border: 1px solid #BCBCBC;background: #DDDDDD;margin: 20px;"> < </span><span id="weekMoveTitle">11월</span><span class="moveRight" style="cursor: pointer;padding: 2px 5px;border: 1px solid #BCBCBC;background: #DDDDDD;margin: 20px;"> > </span ></td>
		      </tr>	 
	<tr>
	    <td>
	    <table border="0" cellpadding="5" cellspacing="0" width="45%" id="tableMonth">
	    	<tbody>
		      <tr>
		      	  <th></th>
...
<%-- toDay:<%=toDay %>
		...
		<tr>
			<td colspan="7">
				<input type="button" id="updateBtn" value="수정" style="height:30px; width:100px;margin: 10px 300px;">
		...
		<tr>
			...
			<input type="button" id="registAllBtn" value="일괄 등록" style="height:30px; width:100px;margin: 10px 300px;">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<input type="button" id="deleteAllBtn" value="삭제" style="height:30px; width:100px;margin: 10px 300px;">
			</td>
		</tr>
...
var month = <%=iMonth %>+1; 
var weekStartDay = (<%=weekStartDay %>)+((weekNo-1)*7);
