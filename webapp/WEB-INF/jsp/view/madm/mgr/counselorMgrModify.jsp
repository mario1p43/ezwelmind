...
<script type="text/javascript">
	...
	function addRowExam(){
		...
		strData += " 센터 내 시행비용(해석상담 포함가) :<input type='text' name='extraExamInfo3' value=''	 /> <br/>";
		strData += "</div>";
	...
	<td valign="top" align="left">
		<table  cellspacing="0" border="1" width="100%" style="border-collapse:collapse;">
			...
			<tr align="left" height="30px">
				...
				<td width="40%" class="line"><input type="number" maxlength="6" id="rrn1" style="width: 20%;" data-validation="length number" data-validation-length="6-6"  data-validation-error-msg="생년월일을 확인 해주세요." />-
		    		...
		    		<input type="radio" name="gender" value="M" ${mgr.gender == 'M'  ? 'checked':''} /> 남성
			...
			<%-- <tr align="left" height="30px">
				...
				<td class="line" colspan="3">
					<span> * 학력은 최소 1개 이상 등록해야 합니다.</span><br />
			...
			<tr>
				...
				<td class="line" colspan="4">
					<div id="etcExamExtra">
							...
							센터 내 시행비용(해석상담 포함가) :<input type="text" name="extraExamInfo3" value="${list.extraCost }"	 />
