...
j$(document).ready(function(){
	...
	$('.item01Ans').click(function() {
		var gSize = "";

		$(".item01Ans:checked").each(function() {
	...
	<td>
		...
		<table cellpadding="5" cellspacing="0" border="1" width="65%" style="border-collapse:collapse;" bordercolor="#DDDDDD">
			...
			<tr>
				...
				<td>
					<input type="hidden" name="item01Ans">
					<input type="checkbox" class="item01Ans" value="0" />0
					<input type="checkbox" class="item01Ans" value="1" />1
                    <input type="checkbox" class="item01Ans" value="2" />2
                    <input type="checkbox" class="item01Ans" value="3" />3
                    <input type="checkbox" class="item01Ans" value="4" />4
                    <input type="checkbox" class="item01Ans" value="5" />5
				</td>
			</tr>
		</table>
		<!-- 검색 영역 종료 -->
		...
		<table cellpadding="0" cellspacing="0" border="0" width="2000px" align="center">
			...
			<tr>
				<td>
					...
					<div>평균 : ${itemAvg.itemAvg } / 최고점 : ${itemAvg.itemMax } / 최하점 : ${itemAvg.itemMin } / (null 미포함)</div>
					<br>
