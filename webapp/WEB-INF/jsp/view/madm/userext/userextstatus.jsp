...
function showDocument(intakeCd,counselNm,centerSeq,clientCd,apprStatus1,apprStatus2,apprStatus3,regId1,regId2,regId3,regDt1,regDt2,regDt3,fileSeq1,fileSeq2,fileSeq3){
			...
			<tr>
				<td colspan="4">
					...
					<table cellpadding="5" cellspacing="0" border="0" width="100%" align="left">
						...
						<input class="fileSeq1" type="hidden" name="fileSeq" class="fileSeq" value="">
					</form>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4">
					...
					<table cellpadding="5" cellspacing="0" border="0" width="100%" align="left">
						...
						<input type="hidden" name="docType" class="docType" value="2">
						<input class="fileSeq2" type="hidden" name="fileSeq" class="fileSeq" value="">
					</form>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4">
					...
					<table cellpadding="5" cellspacing="0" border="0" width="100%" align="left">
						...
						<input type="hidden" name="docType" class="docType" value="2">
						<input class="fileSeq3" type="hidden" name="fileSeq" class="fileSeq" value="">
					</form>
				</td>
			</tr>
			<tr>
		...
		<td>
			<table cellpadding="5" align="" id="chRow" cellspacing="0" border="1" width="100%" style="text-align:center; border-collapse:collapse;">
				...
				<c:forEach var="list" items="${paging.list}" varStatus="status">
					...
					<button onclick="showDocument(${list.intakeCd },'${list.counselNm }',${list.centerSeq },'${list.clientCd }','${list.apprStatus1}','${list.apprStatus2 }','${list.apprStatus3 }','${list.regId1 }','${list.regId2 }','${list.regId3 }','${list.regDt1 }','${list.regDt2 }','${list.regDt3 }' ,'${list.fileSeq1 }','${list.fileSeq2 }','${list.fileSeq3 }' )" >보기</button></td>
