...
function selectNm(Cd,Nm){
	if(document.cspForm.Oform.value == "ogoods"){
		window.opener.onlinegoodsform.cspCd.value=Cd;
		window.opener.onlinegoodsform.cspNm.value=Nm;
		self.close();
	}
	if(document.cspForm.Oform.value == "omental"){
		window.opener.onlinementalform.cspCd.value=Cd;
		window.opener.onlinementalform.cspNm.value=Nm;
		self.close();
	}
	if(document.cspForm.Oform.value == "edu"){
		window.opener.educationform.cspCd.value=Cd;
		window.opener.educationform.cspNm.value=Nm;
		self.close();
	}
	if(document.cspForm.Oform.value == "goods"){
		window.opener.goodsform.cspCd.value=Cd;
		window.opener.goodsform.cspNm.value=Nm;
		self.close();
	}
}
</script>
					...
					<td>
						...
						<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;" bordercolor="#DDDDDD">
							<tr align="left" height="30px">
								<td bgcolor="#F5F5F5" align="center"><strong>업체구분</strong></td>
