	...
	j$('.modify').click(function() {
		...
		j$.alert("변경 하시겠습니까?", function() {
			j$('input:checkbox[name="goodsCdArr"]:unchecked').each(function(){
			 ...
			 j$("#addGoodsForm").attr("action","/madm/service/management/modify");
			 j$("#addGoodsForm").submit();
		}, function() {
		}); // end alert
	});
...
function getcspPopup() {
	window.open("/madm/service/management/cspPopup?Oform=add", "cspPopup", "width=600, height=400,  scrollbars=1");
}

function detail(Cd,Type){
	j$("#addGoodsForm").attr("action","/madm/service/management/modifyGoods?goodsCd="+Cd+"&goodsType="+Type);
	j$("#addGoodsForm").submit();
}
...
<form id="addGoodsForm" name="addGoodsForm" action="/madm/service/management/addgoods" method="POST">
...
<table cellpadding="0" align="left" cellspacing="0" border="0" width="95%">
	...
	<tr>
		<td align="left" class="subtitle">등록상품</td>
	</tr>
	<tr>
		<td height="10px"></td>
	</tr>
		...
		<td>
			...
			<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;" bordercolor="#DDDDDD">
				<tr align="left" height="30px">
					...
					<td bgcolor="#F5F5F5" align="center"><strong>상품유형</strong></td>
			    	<td align="left">
			    		<comm:select name="selectgoodtype" code="100717"  basicValue="전체" selectValue="${param.selectgoodtype}" />
			    	</td>
				</tr>
				<tr align="left" height="30px">
