...
j$(document).ready(function(){
	...
	j$('.modify').click(function() {
		...
		j$.alert("변경 하시겠습니까?", function() {
			...
			j$("#adddelayForm").attr("action","/madm/service/management/modify");
			j$("#adddelayForm").submit();
		}, function() {
		}); // end alert
	});
...
function getcspPopup() {
	window.open("/madm/service/management/cspPopup?Oform=delay", "cspPopup", "width=600, height=400,  scrollbars=1");
}

function detail(Cd,Type){
	j$("#adddelayForm").attr("action","/madm/service/management/modifyGoods?goodsCd="+Cd+"&goodsType="+Type);
	j$("#adddelayForm").submit();
}
</script>
</head>
...
<form id="adddelayForm" name="adddelayForm" action="/madm/service/management/adddelaygoods" method="POST">
