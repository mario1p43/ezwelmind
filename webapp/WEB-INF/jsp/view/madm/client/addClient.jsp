...
j$(document).ready(function(){
	...
	j$("#addClient").validate({
		...
		rules : {
			...
			mobileYn            : {required:true}
		},
		messages: {
			clientCd			: "고객사코드를 입력하세요",
			domainCd		: "도메인코드를 입력하세요",
	...
	j$('#updateBtn').click(function() {
		j$("#addClient").attr("action","/madm/client/update");
...
<%--
	j$('#deleteBtn').click(function() {
		j$("#addClient").attr("action","/madm/client/delete");
...
<body>
<form id="addClient" name="addClient"  action="/madm/client/add" method="POST" enctype="multipart/form-data">
...
<table cellpadding="5" cellspacing="0" border="0" width="95%" style="border-bottom: 1px solid silver;">
	...
	<tr>
		<td align="left" class="subtitle">고객사 등록</td>
	</tr>
</table>
<br/>
<!-- 버튼 영역 종료 -->
	...
	<td valign="top" align="left">
		...
		<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;">
			<tr>
				...
				<td width="30%" ><input type="text" name="clientCd" value="" minlength="2" maxlength="20" /></td>
				<td class="line" width="20%" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>도메인코드</td>
				<td width="30%" ><input type="text" name="domainCd" value="" minlength="2" maxlength="20" /></td>
			</tr>
			<tr>
				<td class="line" width="20%" height="25" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>고객사명</td>
				<td width="80%" colspan="3"><input type="text" name="clientNm" value="" minlength="2" maxlength="50" size="50" /></td>
			</tr>
			<tr>
				<td class="line" width="20%" height="60" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>주소</td>
				<td width="80%" colspan="3">
					<div>
						<input type="text" name="zip1" id="zip1" class="addrPopUp" id="b_zipcode01" title="우편번호 앞자리 입력" style="width:50px;" readonly > -
						<input type="text" name="zip2" id="zip2" class="addrPopUp" title="우편번호 뒷자리 입력" style="width:50px;" readonly >
						<a href="#" class="addrPopUp" >우편번호 찾기</a>
					</div>
					<div class="mt" style="padding-top:10px">
						<input type="text" name="addr1" id="addr1" class="addrPopUp" title="주소입력" style="width:35%;" readonly >
						<input type="text" name="addr2" id="addr2" title="주소입력" style="width:55%;">
					</div>
				</td>
			</tr>
			<tr>
				<td class="line" height="25" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>대표자명</td>
				<td ><input type="text" name="ceoNm" value="" minlength="2" maxlength="50" /></td>
				<td class="line" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>사업자번호</td>
				<td ><input type="text" name="bsnsNum" value="" minlength="4" maxlength="12" /> <span style="color:RED"> "-" 포함 </span></td>
			</tr>
			<tr>
				<td class="line" height="25" align="center" bgcolor="#F5F5F5">전화번호</td>
				<td ><input type="text" name="telNum" value="" minlength="4" maxlength="20" /> <span style="color:RED"> "-" 포함 </span></td>
				<td class="line" align="center" bgcolor="#F5F5F5">팩스번호</td>
				<td ><input type="text" name="faxNum" value="" minlength="4" maxlength="20" /> <span style="color:RED"> "-" 포함 </span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td ><input type="text" name="totEmploy" value="" minlength="1" maxlength="7" /> <span style="color:RED"> 숫자만 입력</span></td>
			</tr>
			<tr>
	...
	<td valign="top" align="left">
		...
		<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;">
			<tr>
				...
				<td width="18%" ><input type="text" name="siteNm" value="" minlength="2" maxlength="50" /></td>
				<td class="line" width="15%" align="center" bgcolor="#F5F5F5">포인트 명칭</td>
				<td width="19%" ><input type="text" name="pointNm" value="" minlength="2" maxlength="30" /></td>
				<td class="line" width="15%" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>포인트 이월</td>
				<td width="18%" >
					<input type="radio" name="pointBringYn" value="Y" > 허용
					<input type="radio" name="pointBringYn" value="N" > 비허용
				</td>
			</tr>
			<tr>
				...
				<td >
					<input type="radio" name="joinType" value="I" > 관리자등록
					<input type="radio" name="joinType" value="J" > 회원가입
				</td>
				<td class="line" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>로그인방식</td>
				<td >
					<input type="radio" name="loginType" value="I" > 아이디
					<input type="radio" name="loginType" value="E" > 사번
				</td>
			</tr>
			<tr>
				...
				<td >
					<input type="radio" name="openYn" value="Y" > Y
					<input type="radio" name="openYn" value="N" > N
				</td>
				<td class="line" align="center" bgcolor="#F5F5F5">고객사오픈일</td>
				<td >
					<input type="text" name="openDd" id="openDd" size="10" value="" class="date_timepicker_openDd"/>
				...
				<td >
					<select name="menuGroup">
						...
						<c:forEach var="list" items="${menuGroupList}" varStatus="status">
							<option value="${list.commNm}">${list.commNm}</option>
						</c:forEach>
					</select>
				</td>
				<td class="line" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>EMS 발송여부</td>
				<td >
					<input type="radio" name="emsRecvYn" value="Y" > Y
					<input type="radio" name="emsRecvYn" value="N" > N
				</td>
				<td class="line" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>SMS 발송여부</td>
				<td >
					<input type="radio" name="smsRecvYn" value="Y" > Y
					<input type="radio" name="smsRecvYn" value="N" > N
				</td>
			</tr>
			<tr>
				<td class="line" height="25" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>현금영수증 포인트 발급여부</td>
				<td >
					<input type="radio" name="receiptPointYn" value="Y" > Y
					<input type="radio" name="receiptPointYn" value="N" > N
				</td>
				<td class="line" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>현금영수증 계좌이체 발급여부</td>
				<td >
					<input type="radio" name="receiptAccountYn" value="Y" > Y
					<input type="radio" name="receiptAccountYn" value="N" > N
				</td>
				<td class="line" align="center" bgcolor="#F5F5F5"><span style="color:RED">* </span>모바일 고객사 여부</td>
				<td >
					<input type="radio" name="mobileYn" value="Y" > Y
					<input type="radio" name="mobileYn" value="N" > N
				</td>
			</tr>
			<tr>
				<td class="line" height="25" align="center" bgcolor="#F5F5F5"> 결제수단 명칭</td>
				<td colspan="5">
					<input type="text" name="payNm" value="" maxlength="30" />
			...
			<tr>
				...
				<td width="80%" >
					<c:forEach var="list" items="${useTypeList}" varStatus="status">
						<input type="checkbox" name="useType" value="${list.commCd}"/>${list.commNm}
					</c:forEach>
				</td>
			</tr>
			<tr>
				...
				<td >
					<c:forEach var="list" items="${useServiceList}" varStatus="status">
						<input type="checkbox" name="useService" value="${list.commCd}"/>${list.commNm}
					</c:forEach>
				</td>
			</tr>
			<tr>
				...
				<td >
					<c:forEach var="list" items="${useChannelList}" varStatus="status">
						<input type="checkbox" name="useChannel" value="${list.commCd}"/>${list.commNm}
					</c:forEach>
				</td>
			</tr>
		</table>
	...
	<td valign="top" align="left">
		...
		<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;">
			<tr>
				...
				<td width="18%" >
					<select name="mgrId">
						...
						<c:forEach var="list" items="${mgrList}" varStatus="status">
							<option value="${list.userId}">${list.userNm}</option>
						</c:forEach>
					</select>
				</td>
				...
				<td width="19%" >
					<input type="text" name="budget" class="onlyNumber" maxlength="10" />
				</td>
			</tr>
			<tr>
				<td class="line" width="15%" align="center" bgcolor="#F5F5F5"> 계약사항</td>
				<td colspan="5">
					<textarea rows="5" cols="10" id="ir1" name="memo" style="width:100%; height:100px;"> </textarea>
		...
		<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;">
			<tr>
				...
				<td width="18%" >
					...
					<input type="text" name="calcDd" value="" minlength="1" maxlength="2" size="3" />일
				</td>
				<td class="line" width="15%" align="center" bgcolor="#F5F5F5"> <span style="color:RED">* </span>과세여부</td>
				<td width="19%" >
					<input type="radio" name="dutyYn" value="Y" > 과세
				...
				<td width="18%" >
					<input type="radio" name="taxYn" value="Y" > 발행
					<input type="radio" name="taxYn" value="N" > 미발행
				</td>
			</tr>
		</table>
	</td>
