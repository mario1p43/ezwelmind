...
<script type="text/javascript">
	...
	jQuery.ajax({
		<c:if test='${not empty clientCd}'>
			url: '/madm/counselTopic/topicMain/init?clientCd=${clientCd}',
			dataType: 'json'
		</c:if>
	}).done(function(data){
	...
	function getParentCode(node) {
		if (node.getParent().data.commNm == null) 
			return 102000; // client생성시 소속1 코드가 100002로 생성 됨.
		else
	...
	function clientCdChange(v) {
		location.href = "/madm/counselTopic/topicMain?clientCd=" + v
	}
...
<body class="example">
	<form id="divisionForm" name="divisionForm" action="/madm/counselTopic/add" method="post">
			...
			<tr>
				<td>
					<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center" style="border-bottom: 1px solid silver;">
						<tr>
							<td align="left" class="subtitle">상담주제 관리</td>
							<td align="right">
							</td>
						</tr>
					</table>
					...
					<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center" >
						<tr>
							<td align="left"> <span style="color:red;"> ※ 상담주제는 3단계까지 노출됩니다. </span> </td>
						</tr>
					</table>
					...
					<table width="100%" >
						<tr>
							<td rowspan="2">
								...
								<input type="button" onclick="addDivision();"  value="상담주제추가"/>
