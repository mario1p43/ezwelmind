...
j$(document).ready(function(){
	...
	j$("#insertBtn").click(function(){
		var url = "/madm/mobile/popupManage/addPopupForm";
		location.href = url;
		return false;
	});
	...
	j$(".popupDetail").click(function(){
		...
		location.href = "/madm/mobile/popupManage/modifyPopupDetail?popupSeq="+popupSeq;
		return false;
	});
...
<form:form id="searchPopup" modelAttribute="invPopupDto" action="/madm/mobile/popupManage/popupMain" method="GET">
