...
j$(document).ready(function(){
	...
	j$("#insertBtn").click(function(){
		var url = "/madm/mobile/banner/addBnrForm?cornerCd=${invBannerDto.cornerCd}";
		location.href = url;
		return false;
	});
	...
	j$(".bannerDetail").click(function(){
		...
		location.href = "/madm/mobile/banner/modifyBnrDetail?bannerSeq="+bnrSeq;
		return false;
	});
...
<form:form id="searchBnr" modelAttribute="invBannerDto" action="/madm/mobile/banner/bnrManage" method="GET">
	...
	<tr>
		<td>
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					<td align="left" class="subtitle">모바일배너 등록관리</td>
				</tr>
				<tr>
					<td height="10px"></td>
				</tr>
