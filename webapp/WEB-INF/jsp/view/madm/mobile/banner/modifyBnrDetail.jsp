...
j$(document).ready(function(){
	...
	j$("#cancleBtn").click(function(){
		location.href = "/madm/mobile/banner/bnrManage?cornerCd=${bnrDetail.cornerCd}";
		return false;
	});
...
<body>
<form:form id="modifyBnr" modelAttribute="ivnBannerDto" action="/madm/mobile/banner/modifyBnrDetail" method="POST" enctype="multipart/form-data">
				...
				<td>
					...
					<table cellpadding="5" cellspacing="0" border="1" width="80%" style="border-collapse:collapse;">
						...
						<tr align="left" height="30px">
					    	...
					    	<td class="line" colspan="3">
					    		<input type="text" name="bannerNm" value="${bnrDetail.bannerNm}" style="width: 300px;" />
					    	</td>
						</tr>
						<tr align="left" height="30px">
							<th class="line" width="15%" align="center" bgcolor="#F5F5F5">타이틀</th>
					    	<td class="line" colspan="3">
					    		<input type="text" name="subject" value="${bnrDetail.subject}" style="width: 300px;" />
					    	</td>
						</tr>
					    <tr align="left" height="30px">
							<th class="line" width="15%" align="center" bgcolor="#F5F5F5">내용</th>
					    	<td class="line" colspan="3">
					    		<textarea rows="5" cols="10" id="comment" name="comment" style="width:100%; height:100px;">${bnrDetail.comment}</textarea>
					    	</td>
						</tr>
						<tr align="left" height="30px">
							<th class="line" width="15%" align="center" bgcolor="#F5F5F5">이미지URL</th>
					    	<td class="line" colspan="3">
				            	<input name="fileNm"  type="file" style="width:350px;"/> &nbsp;
						...
						<tr align="left" height="30px">
							<th class="line" width="15%" align="center" bgcolor="#F5F5F5">노출순서</th>
					    	<td class="line" colspan="3">
					    		<input type="text" name="dispOrder" value="${bnrDetail.dispOrder}" style="width: 300px;" />
					    	</td>
						</tr>
						<tr align="left" height="30px">
							<th class="line" width="15%" align="center" bgcolor="#F5F5F5">노출URL</th>
					    	<td class="line" colspan="3">
...
<form:form id="deleteBnr" modelAttribute="invBannerParam" action="/madm/mobile/banner/modifyBnrDetail" method="DELETE">
	<input type="hidden" name="bannerSeq" value="${bnrDetail.bannerSeq}">
</form:form>
