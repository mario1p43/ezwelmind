...
j$(document).ready(function(){
	...
	j$(".epilogueDetail").click(function(){
		var dataSeq = j$(this).attr("value");
		var bbsCd = j$("#bbsCd").val();
		var serviceType = j$("#serviceType").val();
		location.href = "/madm/bbsEpilogue/modifyEpilogueDetailForm2?dataSeq="+dataSeq+"&bbsCd="+bbsCd+"&serviceType="+serviceType;
		return false;
	});
...
<form:form id="searchEpilogue" modelAttribute="bbsAddDto" action="/madm/bbsEpilogue/list" method="GET">
...
<tr>
	<td>
		...
		<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center" style="border-bottom: 1px solid silver;">
			<tr>
		    	<td align="left" class="subtitle">상담후기 관리</td>
			</tr>
		</table>
		<!-- 버튼 영역 종료 -->
	</td>
		...
		<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse;" bordercolor="#DDDDDD">
			<tr align="left" height="30px">
		    	...
		    	<td width="40%" colspan="3" align="left">
		    		<comm:select name="reqCd1"   code="100855"  basicValue="---- 선택 ----" selectValue="${param.reqCd1}" />
		    	</td>
			</tr>
					...
					<table class="" cellpadding="5" align="" id="chRow" cellspacing="0" border="1" width="100%" style="text-align:center; border-collapse:collapse;">
						...
						<c:forEach var="list" items="${paging.list}" varStatus="status">
							<tr align="" height="50px">
								...
								<td align="center"><a href="javascript:void(0)" class="epilogueDetail" value="${list.dataSeq}" style="padding-left: 10px;"><strong>${list.subject}</strong></a></td>
								<c:choose>
