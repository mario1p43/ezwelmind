...
<tr>
	<td valign="top" align="left">
		<table cellpadding="5" cellspacing="0" border="0" width="100%" align="center" style="border-bottom: 1px solid silver;">
			<tr>
		    	<td align="left" class="subtitle">언론보도 상세</td>
			</tr>
		</table>
	</td>
</tr>
...
<tr>
	<td valign="top" align="left">
		<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse; margin: 15px auto 5px auto;">
		        ...
		        <tr>
					<td class="line" align="center" bgcolor="#F5F5F5">수정자</td>
		        ...
		        <tr>
		            ...
		            <td align="left" colspan="3">
						<input type="text" name="newsDd" id="newsDd" size="10" value="${vo.newsDd}" class="date_timepicker_btstartDt1"/>
						<img src="http://img.ezwel.com/welfare_pms/images/common/icon02.jpg" border="0" />
					</td>
		        </tr>
		        <tr>
		        ...
		        <tr>
		            ...
		            <td colspan="3">
		            	...
		            	<c:forEach begin="0" end="5" var="list" items="${pressList}" varStatus="status">
		            		<table cellpadding="5" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
		            			<tr>
		            				<th colspan="2">관련기사 ${status.count }</th>
		            			</tr>
		            			<tr>
		            				<td>미디어명</td>
		            				<td><input type="text" name="mediaNmArr" size="50" value="${list.mediaNm }"></td>
		            			</tr>
		            			<tr>
		            				<td>기사제목</td>
		            				<td><input type="text" name="mediaSubjectArr" size="50" value="${list.mediaSubject }"></td>
		            			</tr>
		            			<tr>
		            				<td>보도일</td>
		            				<td>
		            					<input type="text" name="mediaDdArr" size="10" value="${list.mediaDd }" class="date_timepicker_btstartDt1"/>
										<img src="http://img.ezwel.com/welfare_pms/images/common/icon02.jpg"border="0" />
									</td>
		            			</tr>
		            			<tr>
		            				<td>링크</td>
		            				<td><input type="text" name="mediaLinkArr" size="100"  value="${list.mediaLink }"/></td>
		            			</tr>
		            		</table>
		            		<c:set var="idx" value="${idx+1 }" />
		            	</c:forEach>
            			<c:if test="${idx < 5 }">
	            			<c:forEach begin="${idx }" end="5">
			            		<table cellpadding="5" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
			            			<tr>
			            				<th colspan="2">관련기사 ${idx }</th>
			            			</tr>
			            			<tr>
			            				<td>미디어명</td>
