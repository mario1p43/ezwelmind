...
j$(document).ready(function(){
	...
	j$("#insertBtn").click(function(){
		...
		location.href = "/madm/partnerNotice/addForm?serviceType="+serviceType+"&bbsCd="+bbsCd;
		return false;
	});
	...
	j$(".noticeDetail").click(function(){
		...
		var bbsCd = j$("#bbsCd").val();
		var serviceType = j$("#serviceType").val();
		location.href = "/madm/partnerNotice/modifyNoticeDetailForm?dataSeq="+dataSeq+"&bbsCd="+bbsCd+"&serviceType="+serviceType;
		return false;
	});
...
<form:form id="searchNotice" modelAttribute="bbsAddDto" action="/madm/partnerNotice/list" method="GET">
