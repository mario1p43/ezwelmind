        ...
        function ajaxFormSubmit(form, s, pd, fileArray, obj, file) {
            ...
            var options = {
                ...
                success: function (data, message, xhr) {
                	/* (lso) 업로드된 실제 파일경로 */
                	var lsoObj = JSON.parse(data);
        			var realPath = "";
        			
        			var pathArr = lsoObj.path.split("\\");
        			
        			//pd.preview.attr('src',"http://localhost/resources/Penguins.jpg");
        			realPath = "http://localhost/" + pathArr[9];
        			pd.filename.html(realPath);
        			pd.preview.attr('src',realPath);
                    pd.preview.show();
