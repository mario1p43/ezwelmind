			...
			return {
				...
				contents: [ {
					...
					},
					{
						...
						validate: CKEDITOR.dialog.validate.notEmpty(editor.lang.image.altTextMissing),
						accessKey: 'T',
						'default': '',
						onChange: function() {
							...
							children: [ {
								...
								html: '<div>' + CKEDITOR.tools.htmlEncode( editor.lang.common.preview ) + '<br>' +
									...
									// jscs:disable maximumLineLength
										( editor.config.image_previewText || '<br>이미지 업로드 완료시 업로드된 이미지 표시<br> 업로드 탭으로 이동해서 이미지를 업로드하세요') +
